...
export const actions = {
    ...
    getItems({ commit }) {
      const url = process.env.VUE_APP_API_URL + '/api/tags'
    ...
    getItem({ commit }, id) {
      const url = process.env.VUE_APP_API_URL + '/api/tags/' + id
    ...
    update({ state, dispatch }) {
      const url = process.env.VUE_APP_API_URL + '/api/tags/' + state.item.id
