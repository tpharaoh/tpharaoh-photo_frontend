...
export const actions = {
    ...
    getItems({ commit }) {
      const url = process.env.VUE_APP_API_URL + '/api/inventories'
    ...
    getItem({ commit }, id) {
      const url = process.env.VUE_APP_API_URL + '/api/inventories/' + id
    ...
    update({ state, dispatch }) {
      const url = process.env.VUE_APP_API_URL + '/api/inventories/' + state.item.id
