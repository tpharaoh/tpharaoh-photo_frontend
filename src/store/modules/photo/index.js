...
export const actions = {
    ...
    getItems({ commit }) {
      const url = process.env.VUE_APP_API_URL + '/api/photos'
    ...
    getItem({ commit }, id) {
      const url = process.env.VUE_APP_API_URL + '/api/photos/' + id
    ...
    update({ state, dispatch }) {
      const url = process.env.VUE_APP_API_URL + '/api/photos/' + state.item.id
